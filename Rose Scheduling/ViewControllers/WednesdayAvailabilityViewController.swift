//
//  WednesdayAvailabilityViewController.swift
//  Rose Scheduling
//
...
class WednesdayAvailabilityViewController: UIViewController {
    @IBOutlet weak var tableView: UITableView!
    
    var tableController: AvailabilityTableController!
        
    override func viewDidLoad() {
        tableController = AvailabilityTableController(day: .wednesday)
