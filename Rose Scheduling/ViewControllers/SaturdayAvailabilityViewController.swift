//
//  SaturdayAvailabilityViewController.swift
//  Rose Scheduling
//
...
class SaturdayAvailabilityViewController: UIViewController {
    @IBOutlet weak var tableView: UITableView!
    
    var tableController: AvailabilityTableController!
        
    override func viewDidLoad() {
        tableController = AvailabilityTableController(day: .saturday)
