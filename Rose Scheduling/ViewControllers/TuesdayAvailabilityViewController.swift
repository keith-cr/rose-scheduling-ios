//
//  TuesdayAvailabilityViewController.swift
//  Rose Scheduling
//
...
class TuesdayAvailabilityViewController: UIViewController {
    @IBOutlet weak var tableView: UITableView!
        
    var tableController: AvailabilityTableController!
    
    override func viewDidLoad() {
        tableController = AvailabilityTableController(day: .tuesday)
