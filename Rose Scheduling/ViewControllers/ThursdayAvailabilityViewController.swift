//
//  ThursdayAvailabilityViewController.swift
//  Rose Scheduling
//
...
class ThursdayAvailabilityViewController: UIViewController {
    @IBOutlet weak var tableView: UITableView!
        
    var tableController: AvailabilityTableController!
    
    override func viewDidLoad() {
        tableController = AvailabilityTableController(day: .thursday)
